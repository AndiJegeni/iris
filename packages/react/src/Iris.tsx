 ...
 */
export function Iris({ daemonUrl = DEFAULT_DAEMON_URL }: IrisProps = {}): null {
  useEffect(() => {
    ...
    const probe = async (): Promise<void> => {
      try {
        ...
        console.info(
          '[iris] daemon not detected on',
          daemonUrl,
          '— run `npx useiris` to enable the overlay',
        );
      }
    };
